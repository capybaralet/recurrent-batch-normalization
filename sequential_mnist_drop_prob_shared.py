...
class LSTM(object):
    ...
    def construct_graph_popstats(self, args, x, drops,
        ...
        def stepfn(x, drops,
            ...
            g, f, i, o_n = [fn(ab[:, j * args.num_hidden:(j + 1) * args.num_hidden])
            ...
            ## Zoneout
            if args.shared:
                o = o * (1-drops) + drops*o_n

            h_n = dummy_h + o_n * self.activation(c_normal)
            if args.zoneout:
